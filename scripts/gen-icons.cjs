...
// Edit _source-1024.png in your design tool to control artwork size/padding,
// then run this script. Requirements: full-bleed 1024×1024 square, no
// transparent corners (macOS applies its own rounded-corner mask at render time).
//
...
async function main() {
  ...
  await sharp(SOURCE).resize(256, 256).png().toFile(path.join(ICONS, 'window-icon.png'));
