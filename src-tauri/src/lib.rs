...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_azure_blob_credentials_for_source,
            commands::update_sftp_credentials,
            ...
            commands::add_snowflake_source,
            commands::add_clickhouse_source,
